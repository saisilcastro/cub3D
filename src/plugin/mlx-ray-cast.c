...
/*   Updated: 2024/02/27 17:38:59 by lde-cast         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static inline t_vf2d	ray_draw(t_object *o, t_chained *img, t_vf2d size, int r)
{
	float	angle;
	t_vf2d	end;
...
void	ray_cast(t_object *obj, t_chained *img, t_vf2d size, char *map)
{
	int		r;
	t_vf2d	end;
